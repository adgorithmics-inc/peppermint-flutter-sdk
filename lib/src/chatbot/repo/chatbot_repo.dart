...
class ChatbotRepo {
  ...
  final String _sendChatUrl = '/api/v1/public-chat/chat/';
  final String _messagesUrl = '/api/v1/public-chat/';

  final String _noConversation = 'Conversation is not initiated yet';
  ...
  Future<Resource<ChatMessage>> sendMessage(String prompt) async {
    ...
    if (conversationId == null) {
      return _noConversation.toResourceFailure();
    }
